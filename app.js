...
var getemoji = require('./routes/getemoji');
...
*/
var whitelist = [
    'http://localhost:3000','http://localhost:4200','http://localhost:5000','http://localhost:3005','http://inclass.alltricks007.vv.si','http://13.71.120.165:3005','http://13.71.120.165:5000','http://13.71.120.165:3000'
];
var corsOptions = {
...
//mongodb://inclass:AkhilamAkhilam1@13.71.120.165:27017/inData
db.connect('mongodb://localhost:27017/MySociety', function(err) {
  if (err) {
